...
\begin{multicols*}{4}
  ...
  \subsubsection*{\underline{Partitioner and Combiner}}
  \begin{itemize}
  ...
  \subsubsection*{\underline{Secondary Sort}}
  ...
  \section{\underline{Relational Databases}}
  ...
  \subsection{\underline{Document Stores}}
  \begin{itemize}
  ...
  \subsubsection*{\underline{Replication in MongoDB}}
  \begin{itemize}
  ...
  \subsection{\underline{Wide Column Stores}}
  \begin{itemize}
  ...
  \subsection{\underline{Vector Databases}}
  \begin{itemize}
  ...
  \section {\underline{Apache Spark}}
  \subsection{\underline{Hadoop vs Spark}}
  ...
  \subsection {\underline{Spark Architecture and APIs}}
  ...
  \subsection{\underline{Machine Learning with Spark}}
  ...
  \section{\underline{Stream Processing}}
...
\subsection{\underline{Event-Time Processing in Flink}}
\begin{itemize}
...
\subsubsection{\underline{State Management}}
...
\subsection{\underline{Graph Processing}}
\includegraphics[width=0.95\linewidth]{graph_processing_tech.png}

\subsubsection{\underline{Simple PageRank}}
...
\begin{itemize}
  ...
  \item \textbf{Voting Formulation:}
    ...
    \subsubsection*{\underline{Topic Specific PageRank}}
