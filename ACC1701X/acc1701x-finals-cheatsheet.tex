...
\subsubsection{\underline{Purchase Discounts/Returns \& Bank Reconcilation}}
...
\includegraphics*[height= 2.3cm,width=0.4\linewidth]{bank_reconcilation.png}
\includegraphics*[height= 2.3cm,width=0.5\linewidth]{internal_controls.png}\\
...
\textbf{Salaries Payable -- CR Cash;}\\
\textbf{Employers CPF Payable; Employees's CPF Payable -- CR Cash}\\
...
- If Gain, debit side. If Loss, credit side.\\
...
- $\textbf{Time Interest Earned} = \frac{\text{Income before interest and taxes (Operating Profit)}}{\text{Annual Interest Expense}}$ [higher better]\\

\subsubsection{\underline{Profitability Ratios}}
- $\textbf{Profit Margin (ROS)} =\frac{\text{Net Income}}{\text{Net Sales}}$\\
...
- $\textbf{Return of Equity} = \text{Return on Sales} \times \text{Asset Turnover} \times \text{Assets-to-equity Ratio}$\\
