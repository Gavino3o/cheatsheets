...
\begin{multicols*}{4}
  ...
  \begin{itemize}
    ...
    \item Shareholders elect a board of directors, who appoints managers to run the company and monitor their performance. Seperation of ownership and control. 
    ...
    \item \textbf{Types of Business Organisations}:
      ...
      \includegraphics[width=0.97\linewidth]{../images/corporation_table.png} 
  \end{itemize}
  ...
  \subsubsection{\underline{Types of Platforms:}}
    \begin{itemize}
      \item \textbf{Product Platforms}: provide a foundation for creating and distributing products or services with improvements over time (e.g. iPhone, Tesla)
      ...
      \item \textbf{Orthogonal Platforms}: Products or services that are based on the sale of different services of two groups of customers who do not come into contact with each other (e.g. newspaper adverstising [client as a target], data brokers [client as a source])
    ...
    \subsubsection{\underline{Advantages of Platform Business Models:}}
      \begin{itemize}
        ...
        \item Focus has shifted from broadcast to segmentation, and then to virality and social influence. 
    ...
    \begin{itemize}
      \item \textbf{Metrics for Traditional Pipeline Model:}
        \begin{itemize}
          ...
          \item Reach customers through proper channels at appropriate prices. (Marketing)
      ...
      \begin{itemize}
        \item Growth of active producers and consumers who are participating in large volumes of successful interactions
      ...
      \item \textbf{Maturity Phase:}
        \begin{itemize}
          \item Driving innovation: platform must adapt to the needs of its users and changes in competitive and regulatory environment.
    ...
    \begin{itemize}
      \item \textbf{Joining the revolution:} Information intensive industries; Industries with non-scalable gatekeepers; Highly fragmented industries (market aggregation); Industries characterised by extreme information assymetries.
    ...
    \textbf{Balance Sheet} \newline
    \includegraphics[width=0.95\linewidth]{../images/balance_sheet_example.png} \newline
    \textbf{Income Statement} \newline
    \includegraphics[width=0.8\linewidth, height=2.8cm]{../images/income_statement_example.png} \newline
    \textbf{Statement of Cash Flow} \newline
    \includegraphics[width=0.8\linewidth, height=3cm]{../images/cash_flow_1.png}
    \includegraphics[width=0.8\linewidth, height=3cm]{../images/cash_flow_2.png}
    \begin{itemize}
    ...
    \end{itemize}
    \includegraphics[width=0.8\linewidth, height=3cm]{../images/cash_flow_example.png}
    ...
    \begin{itemize}
      ...
      \item $\text{cash flow} = \text{net income} + \text{depreciation}$
    \end{itemize}
    ...
    \subsubsection{\underline{Notes}}
    \begin{itemize}
      \item \textbf{Market value} fluctuates due to changes in investor sentiment, market conditions, and company performance.
