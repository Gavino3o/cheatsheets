...
\begin{multicols*}{4}
  ...
  \subsubsection{\underline{Types of Platforms:}}
    ...
    \begin{itemize}
      ...
      \item net working capital = current assets - current liabilities
      ...
      \item taxes = taxable income [EBT] $\times$ tax rate
    ...
    \subsubsection{\underline{Notes}}
    \begin{itemize}
      \item Market value fluctuates due to changes in investor sentiment, market conditions, and company performance, many of which are outside the control of the company.
      \item We are unable to look up the market value of privately owned companies or divisions/plants of larger companies because their shares are not publicly traded.
